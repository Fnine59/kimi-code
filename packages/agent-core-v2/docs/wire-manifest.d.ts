...
//   spine.close                        spine                 persisted  src/agent/spine/spineOps.ts
//   spine.next                         spine                 persisted  src/agent/spine/spineOps.ts
//   spine.open                         spine                 persisted  src/agent/spine/spineOps.ts
//   spine.root_compact                 spine                 persisted  src/agent/spine/spineOps.ts
//   spine.truncate_repair              spine                 persisted  src/agent/spine/spineOps.ts
...
/**
 * model: spine · persisted
 * owner: src/agent/spine/spineOps.ts
 */
interface SpineClosePayload {
  _name: 'spine.close';
  id: string;
  closedAt: number;
  memory: string;
 ...
 * owner: src/agent/spine/spineOps.ts
 */
interface SpineRootCompactPayload {
  _name: 'spine.root_compact';
  epoch: number;
  epochStartAt: number;
  epochMemoryAt: number;
  archivePath?: string;
}
 ...
 * owner: src/agent/spine/spineOps.ts
 */
interface SpineTruncateRepairPayload {
  _name: 'spine.truncate_repair';
  cut: number;
}
