 ...
 *
 * Every artifact (plugin zips, app bundle, Windows installer) is a
 * content-CDN payload funneled through `kimiCdnContentUrl`, resolved at use
 * time so a future region-aware content CDN touches one function.
 */
