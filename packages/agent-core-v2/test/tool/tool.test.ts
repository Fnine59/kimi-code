  ...
  describe('registered user tools', () => {
    ...
    it('routes registered user tools through tool.call request/response', async () => {
      ...
      expect(
        ...
        [emit] agent.status.updated        { "contextTokens": 5, "rawContextTokens": 5 }
        ...
        [emit] agent.status.updated        { "contextTokens": 140, "rawContextTokens": 140 }
        ...
        [emit] agent.status.updated        { "usage": { "byModel": { "mock-model": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
        [emit] agent.status.updated        { "contextTokens": 161, "rawContextTokens": 164 }
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] turn.step.completed         { "turnId": 0, "step": 1, "stepId": "<uuid-1>", "usage": { "inputOther": 140, "output": 21, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "tool_use", "providerFinishReason": "tool_calls", "rawFinishReason": "tool_calls" }
        ...
        [emit] agent.status.updated        { "usage": { "byModel": { "mock-model": { "inputOther": 306, "output": 33, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 306, "output": 33, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 306, "output": 33, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
        [emit] agent.status.updated        { "contextTokens": 178, "rawContextTokens": 181 }
    ...
    `);
      ...
      expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
        ...
        [emit] agent.status.updated         { "contextTokens": 186, "rawContextTokens": 186 }
        ...
        [emit] agent.status.updated         { "usage": { "byModel": { "mock-model": { "inputOther": 492, "output": 44, "inputCacheRead": 0, "inputCacheCreation": 0 } }, "total": { "inputOther": 492, "output": 44, "inputCacheRead": 0, "inputCacheCreation": 0 }, "currentTurn": { "inputOther": 186, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 } } }
        [emit] agent.status.updated         { "contextTokens": 197, "rawContextTokens": 200 }
        [emit] turn.step.completed          { "turnId": 1, "step": 1, "stepId": "<uuid-6>", "usage": { "inputOther": 186, "output": 11, "inputCacheRead": 0, "inputCacheCreation": 0 }, "finishReason": "end_turn", "providerFinishReason": "completed", "rawFinishReason": "stop" }
        [emit] agent.activity.updated       { "lifecycle": "ready", "turn": { "turnId": 1, "origin": { "kind": "user" }, "phase": "running", "step": 1, "ending": false, "pendingApprovals": [], "activeToolCalls": [], "since": "<time>" }, "background": [] }
